...
(function (e) {
    window.elFinder = function (t, n) {
        ...
        this.api = null, this.newAPI = !1, this.oldAPI = !1, this.OS = navigator.userAgent.indexOf("Mac") !== -1 ? "mac" : navigator.userAgent.indexOf("Win") !== -1 ? "win" : "other", this.options = e.extend(!0, {}, this._options, n || {}), n.ui && (this.options.ui = n.ui), n.commands && (this.options.commands = n.commands), n.uiOptions && n.uiOptions.toolbar && (this.options.uiOptions.toolbar = n.uiOptions.toolbar), e.extend(this.options.contextmenu, n.contextmenu), this.requestType = /^(get|post)$/i.test(this.options.requestType) ? this.options.requestType.toLowerCase() : "get", this.customData = e.isPlainObject(this.options.customData) ? this.options.customData : {}, this.id = o, this.uploadURL = n.urlUpload || n.url, this.namespace = u, this.lang = this.i18[this.options.lang] && this.i18[this.options.lang].messages ? this.options.lang : "en", P = this.lang == "en" ? this.i18.en : e.extend(!0, {}, this.i18.en, this.i18[this.lang]), this.direction = P.direction, this.messages = P.messages, this.dateFormat = this.options.dateFormat || P.dateFormat, this.fancyFormat = this.options.fancyDateFormat || P.fancyDateFormat, this.today = (new Date(_.getFullYear(), _.getMonth(), _.getDate())).getTime() / 1e3, this.yesterday = this.today - 86400, D = this.options.UTCDate ? "UTC" : "", this.getHours = "get" + D + "Hours", this.getMinutes = "get" + D + "Minutes", this.getSeconds = "get" + D + "Seconds", this.getDate = "get" + D + "Date", this.getDay = "get" + D + "Day", this.getMonth = "get" + D + "Month", this.getFullYear = "get" + D + "FullYear", this.cssClass = "ui-helper-reset ui-helper-clearfix ui-widget ui-widget-content ui-corner-all elfinder elfinder-" + (this.direction == "rtl" ? "rtl" : "ltr") + " " + this.options.cssClass, this.storage = function () {
        ...
        }), this.compare = e.proxy(this.compare, this), this.notifyDelay = this.options.notifyDelay > 0 ? parseInt(this.options.notifyDelay) : 500, this.draggable = {appendTo: "body", addClasses: !0, delay: 30, revert: !0, refreshPositions: !0, cursor: "move", cursorAt: {left: 50, top: 47}, drag: function (e, t) {
            ...
            return r.trigger("dragstart", {target: i[0], originalEvent: t}), u = i.is("." + r.res("class", "cwdfile")) ? r.selected() : [r.navId2Hash(i.attr("id"))], s.append(o(g[u[0]].mime)).data("files", u).data("locked", !1), (a = u.length) > 1 && s.append(o(g[u[a - 1]].mime) + '<span class="elfinder-drag-num">' + a + "</span>"), s
            ...
            o.length && (n.helper.hide(), r.clipboard(o, !(t.ctrlKey || t.shiftKey || t.metaKey || n.helper.data("locked"))), r.exec("paste", f), r.trigger("drop", {files: s}))
            ...
            var n = this, r = this.options, i = e.Deferred(), s = e.extend({}, r.customData, {mimes: r.onlyMimes}, t.data || t), o = s.cmd, u = !t.preventDefault && !t.preventFail, a = !t.preventDefault && !t.preventDone, f = e.extend({}, t.notify), l = !!t.raw, c = t.syncOnFail, h, t = e.extend({url: r.url, async: !0, type: this.requestType, dataType: "json", cache: !1, data: s}, t.options || {}), p = function (t) {
                ...
                t = n.normalize(t), n.api || (n.api = t.api || 1, n.newAPI = n.api >= 2
            ...
            if (o == "open")while (y = x.pop())!y.isRejected() && !y.isResolved() && (y.quiet = !0, y.abort());
            ...
            }), {added: r, removed: i, changed: s}
        }, this.sync = function () {
            var t = this, n = e.Deferred().done(function () {
                t.trigger("sync")
            }), r = {data: {cmd: "open", init: 1, target: v, tree: this.ui.tree ? 1 : 0}, preventDefault: !0}, i = {data: {cmd: "parents", target: v}, preventDefault: !0};
            return e.when(this.request(r), this.request(i)).fail(function (e) {
                n.reject(e), e && t.request({data: {cmd: "open", target: t.lastDir(""), tree: 1, init: 1}, notify: {type: "open", cnt: 1, hideCnt: !0}})
            }).done(function (e, r) {
            ...
            if (this.options.allowShortcuts && t.pattern && e.isFunction(t.callback)) {
                ...
                for (s = 0; s < n.length; s++)r = n[s], o = r.split("+"), i = (i = o.pop()).length == 1 ? i > 0 ? i : i.charCodeAt(0) : e.ui.keyCode[i], i && !w[r] && (w[r] = {keyCode: i, altKey: e.inArray("ALT", o) != -1, ctrlKey: e.inArray("CTRL", o) != -1, shiftKey: e.inArray("SHIFT", o) != -1, type: t.type || "keydown", callback: t.callback, description: t.description, pattern: r})
            }
            return this
            ...
            return t !== void 0 && (E.length && this.trigger("unlockfiles", {files: r()}), S = [], E = e.map(t || [], function (e) {
                var t = g[e];
                return t ? (S.push(e), {hash: e, phash: t.phash, name: t.name, mime: t.mime, read: t.read, locked: t.locked, cut: !!n}) : null
            }), this.trigger("changeclipboard", {clipboard: E.slice(0, E.length)}), n && this.trigger("lockfiles", {files: r()})), E.slice(0, E.length)
            ...
            t && t[0].elfinder && (this.trigger("destroy").disable(), b = {}, w = {}, e(document).add(t).unbind("." + this.namespace), r.trigger = function () {
            }, t.children().remove(), t.append(i.contents()).removeClass(this.cssClass).attr("style", s), t[0].elfinder = null, L && clearInterval(L))
        };
        ...
        e.extend(e.ui.keyCode, {F1: 112, F2: 113, F3: 114, F4: 115, F5: 116, F6: 117, F7: 118, F8: 119, F9: 120}), this.dragUpload = !1, this.xhrUpload = typeof XMLHttpRequestUpload != "undefined" && typeof File != "undefined" && typeof FormData != "undefined", this.transport = {}, typeof this.options.transport == "object" && (this.transport = this.options.transport, typeof this.transport.init == "function" && this.transport.init(this)), typeof this.transport.send != "function" && (this.transport.send = function (t) {
            ...
            var n = {cssClass: "elfinder-dialog-error", title: r.i18n(r.i18n("error")), resizable: !1, destroyOnClose: !0, buttons: {}};
        ...
        }), t[0].elfinder = this, this.options.resizable && e.fn.resizable && t.resizable({handles: "se", minWidth: 300, minHeight: 200}), this.options.width && (N = this.options.width), this.options.height && (C = parseInt(this.options.height)), r.resize(N, C), e(document).bind("click." + this.namespace,function (n) {
            c && !e(n.target).closest(t).length && r.disable()
        }).bind(f + " " + l, M), this.trigger("init").request({data: {cmd: "open", target: r.lastDir(), init: 1, tree: this.ui.tree ? 1 : 0}, preventDone: !0, notify: {type: "open", cnt: 1, hideCnt: !0}, freeze: !0}).fail(function () {
    ...
    }, iframeCnt: 0, uploads: {iframe: function (t, n) {
        var r = n ? n : this, i = t.input, s = e.Deferred().fail(function (e) {
        ...
        }), o = "iframe-" + r.namespace + ++r.iframeCnt, u = e('<form action="' + r.uploadURL + '" method="post" enctype="multipart/form-data" encoding="multipart/form-data" target="' + o + '" style="display:none"><input type="hidden" name="cmd" value="upload" /></form>'), a = e.browser.msie, f = function () {
            ...
            l.unbind("load").bind("load", function () {
                ...
                h = !0, r.notify({type: "upload", cnt: c})
        ...
        var r = n ? n : this, i = e.Deferred().fail(function (e) {
            ...
            h && clearTimeout(h), l && r.notify({type: "upload", cnt: -a, progress: 100 * a})
        }), s = new XMLHttpRequest, o = new FormData, u = t.input ? t.input.files : t.files, a = u.length, f = 5, l = !1, c = function () {
            return setTimeout(function () {
                l = !0, r.notify({type: "upload", cnt: a, progress: f * a})
        ...
        s.addEventListener("error", function () {
            ...
            var t = f, n;
            e.lengthComputable && (n = parseInt(e.loaded * 100 / e.total), n > 0 && !h && (h = c()), n - t > 4 && (f = n, l && r.notify({type: "upload", cnt: 0, progress: (f - t) * a})))
        ...
        return n ? (s.length || (s = e(o.replace(/\{type\}/g, n).replace(/\{msg\}/g, r)).appendTo(i).data("cnt", 0), a && s.data({progress: 0, total: 0})), f = u + parseInt(s.data("cnt")), f > 0 ? (!t.hideCnt && s.children(".elfinder-notify-cnt").text("(" + f + ")"), i.is(":hidden") && i.elfinderdialog("open"), s.data("cnt", f), a < 100 && (l = s.data("total")) >= 0 && (c = s.data("progress")) >= 0 && (l = u + parseInt(s.data("total")), c = a + c, a = parseInt(c / l), s.data({progress: c, total: l}), i.find(".elfinder-notify-progress").animate({width: (a < 100 ? a : 100) + "%"}, 20))) : (s.remove(), !i.children().length && i.elfinderdialog("close")), this) : this
    }, confirm: function (t) {
        var n = !1, r = {cssClass: "elfinder-dialog-confirm", modal: !0, resizable: !1, title: this.i18n(t.title || "confirmReq"), buttons: {}, close: function () {
        ...
        for (o = 0; o < arguments.length; o++) {
            a = arguments[o];
            if (typeof a == "string")r.push(s(a)); else if (e.isArray(a))for (u = 0; u < a.length; u++)typeof a[u] == "string" && r.push(s(a[u]))
        }
        ...
        this.fm = t, this.name = "", this.title = "", this.state = -1, this.alwaysEnabled = !1, this._disabled = !1, this.disableOnSearch = !1, this.updateOnSelect = !0, this._handlers = {enable: function () {
            ...
            var t, n;
            if (typeof e == "function")this.listeners.push(e); else for (n = 0; n < this.listeners.length; n++) {
                t = this.listeners[n];
                try {
    ...
    }, mimes: {text: ["application/x-empty", "application/javascript", "application/xhtml+xml", "audio/x-mp3-playlist", "application/x-web-config", "application/docbook+xml", "application/x-php", "application/x-perl", "application/x-awk", "application/x-config", "application/x-csh", "application/xml"]}, mixin: {make: function () {
        var t = this.fm, n = this.name, r = t.getUI("cwd"), i = e.Deferred().fail(function (e) {
            e && t.error(e)
        }).always(function () {
            l.remove(), f.remove(), t.enable()
        }), s = "tmp_" + parseInt(Math.random() * 1e5), o = t.cwd().hash, u = new Date, a = {hash: s, name: t.uniqueName(this.prefix), mime: this.mime, read: !0, write: !0, date: "Today " + u.getHours() + ":" + u.getMinutes()}, f = r.trigger("create." + t.namespace, a).find("#" + s), l = e('<input type="text"/>').keydown(function (t) {
            ...
            if (u.length) {
                ...
                u.html(t.escape(r)), t.lockfiles({files: [s]}), t.request({data: {cmd: n, name: r, target: o}, notify: {type: n, cnt: 1}, preventFail: !0, syncOnFail: !0}).fail(function (e) {
                    i.reject(e)
                }).done(function (e) {
                    i.resolve(e)
                })
        ...
        this.not(".elfinder").each(function () {
            var i = e(document), s = e('<div class="ui-widget-header dialogelfinder-drag ui-corner-top">' + (t.title || "Files") + "</div>"), o = e('<a href="#" class="dialogelfinder-drag-close ui-corner-all"><span class="ui-icon ui-icon-closethick"/></a>').appendTo(s).click(function (e) {
                e.preventDefault(), u.dialogelfinder("close")
            }), u = e(this).addClass("dialogelfinder").css("position", "absolute").hide().appendTo("body").draggable({handle: ".dialogelfinder-drag", containment: "parent"}).elfinder(t).prepend(s), a = u.elfinder("instance");
        ...
        if (t == "open") {
            var i = e(this), s = i.data(n) || {top: parseInt(e(document).scrollTop() + (e(window).height() < i.height() ? 2 : (e(window).height() - i.height()) / 2)), left: parseInt(e(document).scrollLeft() + (e(window).width() < i.width() ? 2 : (e(window).width() - i.width()) / 2))}, o = 100;
        ...
        return this.each(function () {
            var n = "class", r = t.fm, i = r.res(n, "disabled"), s = r.res(n, "active"), o = r.res(n, "hover"), u = "elfinder-button-menu-item", a = "elfinder-button-menu-item-selected", f, l = e(this).addClass("ui-state-default elfinder-button").attr("title", t.title).append('<span class="elfinder-button-icon elfinder-button-icon-' + t.name + '"/>').hover(function (e) {
        ...
        return this.each(function () {
            var n = e(this).addClass("ui-helper-reset ui-widget ui-state-default ui-corner-all elfinder-contextmenu elfinder-contextmenu-" + t.direction).hide().appendTo("body").delegate(".elfinder-contextmenu-item", "hover", function () {
                ...
                var o = e(window), u = n.outerWidth(), a = n.outerHeight(), f = o.width(), l = o.height(), c = o.scrollTop(), h = o.scrollLeft(), p = {top: (s + a < l ? s : s - a > 0 ? s - a : s) + c, left: (i + u < f ? i : i - u) + h, "z-index": 100 + t.getUI("workzone").zIndex()};
                n.css(p).show(), p = {"z-index": p["z-index"] + 10}, p[r] = parseInt(n.width()), n.find(".elfinder-contextmenu-sub").css(p)
            }, a = function () {
                n.hide().empty()
            }, f = function (r, s) {
                var u = !1;
                e.each(i[r] || [], function (r, i) {
                    ...
                    if (f && f.getstate(s) != -1) {
                        if (f.variants) {
                            ...
                            }), c = e('<div class="ui-corner-all elfinder-contextmenu-sub"/>').appendTo(l.append('<span class="elfinder-contextmenu-arrow"/>')), l.addClass("elfinder-contextmenu-group").hover(function () {
                                c.toggle()
        ...
        return this.not(".elfinder-cwd").each(function () {
            var r = t.viewType == "list", i = "undefined", s = "select." + t.namespace, o = "unselect." + t.namespace, u = "disable." + t.namespace, a = "enable." + t.namespace, f = "class", l = t.res(f, "cwdfile"), c = "." + l, h = "ui-selected", p = t.res(f, "disabled"), d = t.res(f, "draggable"), v = t.res(f, "droppable"), m = t.res(f, "hover"), g = t.res(f, "adroppable"), y = l + "-tmp", b = t.options.loadTmbs > 0 ? t.options.loadTmbs : 5, w = "", E = [], S = {icon: '<div id="{hash}" class="' + l + ' {permsclass} {dirclass} ui-corner-all" title="{tooltip}"><div class="elfinder-cwd-file-wrapper ui-corner-all"><div class="elfinder-cwd-icon {mime} ui-corner-all" unselectable="on" {style}/>{marker}</div><div class="elfinder-cwd-filename" title="{name}">{name}</div></div>', row: '<tr id="{hash}" class="' + l + ' {permsclass} {dirclass}" title="{tooltip}"><td><div class="elfinder-cwd-file-wrapper"><span class="elfinder-cwd-icon {mime}"/>{marker}<span class="elfinder-cwd-filename">{name}</span></div></td><td>{perms}</td><td>{date}</td><td>{size}</td><td>{kind}</td></tr>'}, x = t.res("tpl", "perms"), T = t.res("tpl", "symlink"), N = {permsclass: function (e) {
                ...
                var i = e.ui.keyCode, u = t == i.LEFT || t == i.UP, a = V.find("[id]." + h), f = u ? "first:" : "last", l, c, d, v, m;
                if (a.length) {
                    l = a.filter(u ? ":first" : ":last"), d = g(l, u ? "prev" : "next");
                    if (!d.length)c = l; else if (r || t == i.LEFT || t == i.RIGHT)c = d; else {
                ...
                var t = e.position().top, n = e.outerHeight(!0), r = J.scrollTop(), i = J.innerHeight();
                ...
                var n = [], i = !1, s = [], o = {}, u = V.find("[id]:last"), a = !u.length, f = r ? V.children("table").children("tbody") : V, l;
            ...
            }, F = e.extend({}, t.droppable, {over: function (n, r) {
                var i = t.cwd().hash;
                ...
                var n = [];
                if (t.oldAPI) {
                    t.request({data: {cmd: "tmb", current: t.cwd().hash}, preventFail: !0}).done(function (e) {
                        q(e.images || []) && e.tmb && R()
                    });
                    return
                }
                n = n = e.splice(0, b), n.length && t.request({data: {cmd: "tmb", targets: n}, preventFail: !0}).done(function (t) {
                    q(t.images || []) && R(e)
                })
            }, U = function (e) {
                var n = r ? V.find("tbody") : V, i = e.length, s = [], o = {}, u = !1, a = function (e) {
            ...
            }, W = {name: t.i18n("name"), perm: t.i18n("perms"), mod: t.i18n("modify"), size: t.i18n("size"), kind: t.i18n("kind")}, X = function (i, s) {
                var o = t.cwd().hash;
                try {
                ...
                if (n.oldSchool && o && !w) {
                    var a = e.extend(!0, {}, t.file(o), {name: "..", mime: "directory"});
                ...
                var n = this.id ? e(this) : e(this).parents("[id]:first"), r = n.prevAll("." + h + ":first"), i = n.nextAll("." + h + ":first"), u = r.length, a = i.length, f;
                ...
                r.length && (n.stopPropagation(), n.preventDefault(), r.is("." + p) || (r.is("." + h) || (V.trigger("unselectall"), r.trigger(s), _()), t.trigger("contextmenu", {type: "files", targets: t.selected(), x: n.clientX, y: n.clientY})))
            }).selectable({filter: c, stop: _, selected: function (t, n) {
                e(n.selected).trigger(s)
            }, unselected: function (t, n) {
                e(n.unselected).trigger(o)
            }}).droppable(F).bind("create." + t.namespace,function (t, n) {
                var i = r ? V.find("tbody") : V, s = i.find(".elfinder-cwd-parent"), n = e(C(n)).addClass(y);
            ...
            }, Q = e(this).parent().resize(K), G = Q.children(".elfinder-workzone").append(J.append(this));
            t.dragUpload && (J[0].addEventListener("dragenter", function (e) {
                ...
                e.preventDefault(), J.removeClass(g), e.dataTransfer && e.dataTransfer.files && e.dataTransfer.files.length && t.exec("upload", {files: e.dataTransfer.files})
                ...
                ,function () {
                    ...
                    var n = [], r;
                    V.find("[id]:not(." + h + "):not(.elfinder-cwd-parent)").trigger(s), P.length ? (r = t.cwd().hash, t.select({selected: e.map(t.files(), function (e) {
                        return e.phash == r ? e.hash : null
                    })})) : _()
                }}).shortcut({pattern: "left right up down shift+left shift+right shift+up shift+down", description: "selectfiles", type: "keydown", callback: function (e) {
                    L(e.keyCode, e.shiftKey)
                }}).shortcut({pattern: "home", description: "selectffile", callback: function (e) {
                    O(), D(V.find("[id]:first").trigger(s)), _()
                }}).shortcut({pattern: "end", description: "selectlfile", callback: function (e) {
        ...
        return typeof t == "string" && (n = this.closest(".ui-dialog")).length && (t == "open" ? n.css("display") == "none" && n.fadeIn(120, function () {
            ...
            var n = e(this).addClass("ui-dialog-content ui-widget-content"), r = n.parent(), i = "elfinder-dialog-active", s = "elfinder-dialog", o = "elfinder-dialog-notify", u = "ui-state-hover", a = parseInt(Math.random() * 1e6), f = r.children(".elfinder-overlay"), l = e('<div class="ui-dialog-buttonset"/>'), c = e('<div class=" ui-helper-clearfix ui-dialog-buttonpane ui-widget-content"/>').append(l), h = e('<div class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-draggable std42-dialog  ' + s + " " + t.cssClass + '"/>').hide().append(n).appendTo(r).draggable({handle: ".ui-dialog-titlebar", containment: e("body")}).css({width: t.width, height: t.height}).mousedown(function (t) {
                ...
                t.modal && f.elfinderoverlay("show"), h.trigger("totop"), typeof t.open == "function" && e.proxy(t.open, n[0])(), h.is("." + o) || r.find("." + s + ":visible").not("." + o).each(function () {
                    ...
                    t[0] != h[0] && (n == i || r == s) && h.css({top: n + 10 + "px", left: r + 10 + "px"})
                })
            }).bind("close",function () {
            ...
            t.position || (d = parseInt((r.height() - h.outerHeight()) / 2 - 42), t.position = {top: (d > 0 ? d : 0) + "px", left: parseInt((r.width() - h.outerWidth()) / 2) + "px"}), h.css(t.position), t.closeOnEscape && e(document).bind("keyup." + a, function (t) {
                ...
                l.append(i)
            }), l.children().length && h.append(c), t.resizable && e.fn.resizable && h.resizable({minWidth: t.minWidth, minHeight: t.minHeight, alsoResize: this}), typeof t.create == "function" && e.proxy(t.create, this)(), t.autoOpen && n.elfinderdialog("open")
        }), this
        ...
        return this.not(".elfinder-navbar").each(function () {
            ...
            e.fn.resizable && (a = r.resizable({handles: u ? "e" : "w", minWidth: n.minWidth || 150, maxWidth: n.maxWidth || 500}).bind("resize scroll",function () {
                a.css({top: parseInt(r.scrollTop()) + "px", left: parseInt(u ? r.width() + r.scrollLeft() - a.width() - 2 : r.scrollLeft() + 2)})
        ...
        this.filter(":not(.elfinder-overlay)").each(function () {
            t = e.extend({}, t), e(this).addClass("ui-widget-overlay elfinder-overlay").hide().mousedown(function (e) {
                e.preventDefault(), e.stopPropagation()
            }).data({cnt: 0, show: typeof t.show == "function" ? t.show : function () {
        ...
        return this.each(function () {
            var r = [], i = "class", s = t.res(i, "navdir"), o = t.res(i, "navcollapse"), u = t.res(i, "navexpand"), a = t.res(i, "hover"), f = t.res(i, "treeroot"), l = t.res("tpl", "navdir"), c = t.res("tpl", "perms"), h = e(t.res("tpl", "navspinner")), p = function (e) {
                ...
                }), r.push(n.hash), !i.parent().length && S.append(i), E.addClass(o), i.draggable({appendTo: "body", revert: !1, helper: function () {
                    var n = e(this);
            ...
            }, w = m({hash: "root-" + t.namespace, name: t.i18n(n.name, "places"), read: !0, write: !0}), E = w.children("." + s).addClass(f).click(function () {
            ...
            }).droppable({tolerance: "pointer", accept: ".elfinder-cwd-file-wrapper,.elfinder-tree-dir,.elfinder-cwd-file", hoverClass: t.res("class", "adroppable"), drop: function (n, i) {
                var s = !0;
            ...
            t.one("load", function () {
                ...
                x.show().parent().show(), r = e.map(t.storage("places").split(","), function (e) {
                    return e || null
                }), r.length && (E.prepend(h), t.request({data: {cmd: "info", targets: r}, preventDefault: !0}).done(function (n) {
                    ...
                    r.length && (E.prepend(h), t.request({data: {cmd: "info", targets: r}, preventDefault: !0}).done(function (t) {
        ...
        return this.each(function () {
            var n = !1, r = e(this).hide().addClass("ui-widget-content elfinder-button " + t.fm.res("class", "searchbtn") + ""), i = function () {
            ...
            e('<span class="ui-icon ui-icon-search" title="' + t.title + '"/>').appendTo(r).click(i), e('<span class="ui-icon ui-icon-close"/>').appendTo(r).click(s), setTimeout(function () {
                ...
                if (e.browser.msie) {
                    ...
                    n.css({right: "", left: parseInt(r.width()) - n.outerWidth(!0)})
                }
                ...
                o.val("")
            }).viewchange(s).shortcut({pattern: "ctrl+f f3", description: t.title, callback: function () {
                o.select().focus()
            }})
        })
        ...
        return this.each(function () {
            ...
            e.each(n.sortRules, function (t, r) {
                ...
                t.exec([], {type: i, order: i == n.sortType ? n.sortOrder == "asc" ? "desc" : "asc" : n.sortOrder, stick: n.sortStickFolders})
        ...
        return this.not("." + r).each(function () {
            var i = "class", s = t.res(i, "treeroot"), o = n.openRootOnLoad, u = t.res(i, "navsubtree"), a = t.res(i, "treedir"), f = t.res(i, "navcollapse"), l = t.res(i, "navexpand"), c = "elfinder-subtree-loaded", h = t.res(i, "navarrow"), p = t.res(i, "active"), d = t.res(i, "adroppable"), v = t.res(i, "hover"), m = t.res(i, "disabled"), g = t.res(i, "draggable"), y = t.res(i, "droppable"), b = function (e) {
            ...
            }, w = t.droppable.drop, E = e.extend(!0, {}, t.droppable, {over: function (t) {
                var n = e(this), r = v + " " + d;
            ...
            }}), S = e(t.res("tpl", "navspinner")), x = t.res("tpl", "navdir"), T = t.res("tpl", "perms"), N = t.res("tpl", "symlink"), C = {id: function (e) {
                ...
                n.stopPropagation(), i.is("." + c) ? (i.toggleClass(l), s.slideToggle()) : (S.insertBefore(r), i.removeClass(f), t.request({cmd: "tree", target: t.navId2Hash(i.attr("id"))}).done(function (e) {
        ...
        return this.each(function () {
            var n = e(this).elfinderbutton(t).unbind("click"), r = e("<form/>").appendTo(n), i = e('<input type="file" multiple="true"/>').change(function () {
                var n = e(this);
                n.val() && (t.exec({input: n.remove()[0]}), i.clone(!0).appendTo(r))
            });
        ...
        return this.not("." + n).each(function () {
            var t = e(this).addClass(n), r = t.outerHeight(!0) - t.height(), i = t.parent();
        ...
        this.variants = [], this.disableOnSearch = !0, n.bind("open reload", function () {
            ...
            var s = this.files(t), o = s.length, u = i || r[0], a = n.cwd(), f = ["errArchive", "errPerm"], l = e.Deferred().fail(function (e) {
                e && n.error(e)
            }), c;
            ...
            return n.request({data: {cmd: "archive", targets: this.hashes(t), type: u}, notify: {type: "archive", cnt: 1}, syncOnFail: !0})
        }
        ...
        this.shortcuts = [
            ...
            }), r.isRejected() ? r : r.resolve(n.clipboard(this.hashes(t)))
        }
        ...
        this.shortcuts = [
            ...
            }), r.isRejected() ? r : r.resolve(n.clipboard(this.hashes(t), !0))
        }
        ...
        this.shortcuts = [
            ...
            }), n.trigger("download", {files: s}), o.resolve(t)
        }
        ...
        this.getstate = function (n) {
            ...
            }), s.isRejected() ? s : n.request({data: {cmd: "duplicate", targets: this.hashes(t)}, notify: {type: "copy", cnt: i}}))
        }
        ...
        var t = this, n = this.fm, r = n.res("mimes", "text") || [], i = function (n) {
            ...
            }, l = {title: i.name, width: t.options.dialogWidth || 450, buttons: {}, close: function () {
            ...
            return u.getContent = function () {
                ...
                if (e.inArray(i.mime, n.mimes || []) !== -1 && typeof n.load == "function" && typeof n.save == "function")return u.editor = {load: n.load, save: n.save, close: typeof n.close == "function" ? n.close : function () {
                }, instance: null}, !1
            ...
            var r = t.hash, i = n.options, o = e.Deferred(), u = {cmd: "file", target: r}, a = n.url(r) || n.options.url, f = "edit-" + n.namespace + "-" + t.hash, l = n.getUI().find("#" + f), c;
            return l.length ? (l.elfinderdialog("toTop"), o.resolve()) : !t.read || !t.write ? (c = ["errOpen", t.name, "errPerm"], n.error(c), o.reject(c)) : (n.request({data: {cmd: "get", target: r}, notify: {type: "openfile", cnt: 1}, syncOnFail: !0}).done(function (e) {
                s(f, t, e.content).done(function (e) {
                    n.request({options: {type: "post"}, data: {cmd: "put", target: r, content: e}, notify: {type: "save", cnt: 1}, syncOnFail: !0}).fail(function (e) {
                        o.reject(e)
                    }).done(function (e) {
        ...
        this.disableOnSearch = !0, n.bind("open reload", function () {
            ...
            for (a = 0; a < o; a++) {
                ...
                n.request({data: {cmd: "extract", target: f.hash}, notify: {type: "extract", cnt: 1}, syncOnFail: !0}).fail(function (e) {
        ...
        this.alwaysEnabled = !0, this.callback = n.options.getFileCallback, this._disabled = typeof this.callback == "function", this.getstate = function (e) {
            ...
            var r = this.fm, i = this.options, s = this.files(n), o = s.length, u = r.option("url"), a = r.option("tmbUrl"), f = e.Deferred().done(function (e) {
                r.trigger("getfile", {files: e}), t.callback(e, r), i.oncomplete == "close" ? r.hide() : i.oncomplete == "destroy" && r.destroy()
            }), l = function (t) {
            ...
            for (h = 0; h < o; h++) {
                ...
                p.baseUrl = u, p.url = r.url(p.hash), p.path = r.path(p.hash), p.tmb && p.tmb != 1 && (p.tmb = a + p.tmb), !p.width && !p.height && (p.dim ? (d = p.dim.split("x"), p.width = d[0], p.height = d[1]) : p.mime.indexOf("image") !== -1 && c.push(r.request({data: {cmd: "dim", target: p.hash}, preventDefault: !0}).done(e.proxy(function (e) {
        ...
        this.alwaysEnabled = !0, this.updateOnSelect = !1, this.state = 0, this.shortcuts = [
            ...
            this.dialog || (this.dialog = this.fm.dialog(w, {title: this.title, width: 530, autoOpen: !1, destroyOnClose: !1})), this.dialog.elfinderdialog("open").find(".ui-tabs-nav li a:first").click()
        }
        ...
        this.tpl = {main: '<div class="ui-helper-clearfix elfinder-info-title"><span class="elfinder-cwd-icon {class} ui-corner-all"/>{title}</div><table class="elfinder-info-tb">{content}</table>', itemTitle: '<strong>{name}</strong><span class="elfinder-info-kind">{kind}</span>', groupTitle: "<strong>{items}: {num}</strong>", row: "<tr><td>{label} : </td><td>{value}</td></tr>", spinner: '<span>{text}</span> <span class="' + r + '"/>'}, this.alwaysEnabled = !0, this.updateOnSelect = !1, this.shortcuts = [
            ...
            var n = this, s = this.fm, o = this.tpl, u = o.row, a = this.files(t), f = a.length, l = [], c = o.main, h = "{label}", p = "{value}", d = {title: this.title, width: "auto", close: function () {
            ...
            }).attr("src", w), v.length && s.request({data: {cmd: "size", targets: v}, preventDefault: !0}).fail(function () {
                m(i.unknown)
            }).done(function (e) {
        ...
        this.alwaysEnabled = !0, this.updateOnSelect = !1, this.drivers = [], this.handlers = {load: function () {
            ...
            var n = t.fm, r = e.Deferred(), i = function () {
                var i = {protocol: e("<select/>"), host: e('<input type="text"/>'), port: e('<input type="text"/>'), path: e('<input type="text" value="/"/>'), user: e('<input type="text"/>'), pass: e('<input type="password"/>')}, s = {title: n.i18n("netMountDialogTitle"), resizable: !1, modal: !0, destroyOnClose: !0, close: function () {
                    delete t.dialog, !r.isResolved() && !r.isRejected() && r.reject()
                }, buttons: {}}, o = e('<table class="elfinder-info-tb elfinder-netmount-tb"/>');
                return e.each(t.drivers, function (e, t) {
                    ...
                    if (!n.host)return t.fm.trigger("error", {error: "errNetMountHostReq"});
        ...
        this.alwaysEnabled = !0, this._handlers = {dblclick: function (e) {
            ...
            if (s == 1 && (o = i[0]) && o.mime == "directory")return o && !o.read ? r.reject(["errOpen", o.name, "errPerm"]) : n.request({data: {cmd: "open", target: o.thash || o.hash}, notify: {type: "open", cnt: 1, hideCnt: !0}, syncOnFail: !0});
        ...
        this.updateOnSelect = !1, this.handlers = {changeclipboard: function () {
            ...
            var n = this, r = n.fm, t = t ? this.files(t)[0] : r.cwd(), i = r.clipboard(), s = i.length, o = s ? i[0].cut : !1, u = o ? "errMove" : "errCopy", a = [], f = [], l = e.Deferred().fail(function (e) {
                e && r.error(e)
            }), c = function (t) {
                ...
                var s = e.Deferred(), u = [], a = function (t, n) {
                    ...
                    if (!n)return;
                    r.confirm({title: r.i18n(o ? "moveFiles" : "copyFiles"), text: r.i18n(["errExists", n.name, "confirmRepl"]), all: !a, accept: {label: "btnYes", callback: function (t) {
                        !a && !t ? f(++e) : c(i)
                    ...
                    f = n[0].phash, n = e.map(n, function (e) {
                        return e.hash
                    }), r.request({data: {cmd: "paste", dst: t.hash, targets: n, cut: o ? 1 : 0, src: f}, notify: {type: o ? "move" : "copy", cnt: i}}).always(function () {
                        s.resolve(), r.unlockfiles({files: n})
                    })
                };
                ...
                })) : r.request({data: {cmd: "ls", target: t.hash}, notify: {type: "prepare", cnt: 1, hideCnt: !0}, preventFail: !0}).always(function (e) {
                    l(e.list || [])
                }) : c(i), s)
            }, p, d;
            return!s || !t || t.mime != "directory" ? l.reject() : t.write ? (p = r.parents(t.hash), e.each(i, function (n, s) {
                ...
                s.phash == t.hash ? f.push(s.hash) : a.push({hash: s.hash, phash: s.phash, name: s.name})
            }), l.isRejected() ? l : e.when(c(f), h(a)).always(function () {
                o && r.clipboard([])
        ...
        var t = this, n = t.fm, r = 0, i = 1, s = 2, o = r, u = "elfinder-quicklook-navbar-icon", a = "elfinder-quicklook-fullscreen", f = function (t) {
            ...
            return{opacity: 0, width: 20, height: n.view == "list" ? 1 : 20, top: e.offset().top + "px", left: e.offset().left + "px"}
        }, c = function () {
            var t = e(window);
            return{opacity: 1, width: p, height: d, top: parseInt((t.height() - d) / 2 + t.scrollTop()), left: parseInt((t.width() - p) / 2 + t.scrollLeft())}
        }, h = function (e) {
            ...
            r.stopPropagation(), s ? (i.css(i.data("position")).unbind("mousemove"), f.unbind(o).trigger(t.resize).unbind(t.resize), E.unbind("mouseenter").unbind("mousemove")) : (i.data("position", {left: i.css("left"), top: i.css("top"), width: i.width(), height: i.height()}).css({width: "100%", height: "100%"}), e(window).bind(o,function () {
        ...
        this.resize = "resize." + n.namespace, this.info = e('<div class="elfinder-quicklook-info-wrapper"/>').append(y).append(b), this.preview = e('<div class="elfinder-quicklook-preview ui-helper-clearfix"/>').bind("change",function (e) {
            ...
            {pattern: "space"}
        ], this.support = {audio: {ogg: h('audio/ogg; codecs="vorbis"'), mp3: h("audio/mpeg;"), wav: h('audio/wav; codecs="1"'), m4a: h("audio/x-m4a;") || h("audio/aac;")}, video: {ogg: h('video/ogg; codecs="theora"'), webm: h('video/webm; codecs="vp8, vorbis"'), mp4: h('video/mp4; codecs="avc1.42E01E"') || h('video/mp4; codecs="avc1.42E01E, mp4a.40.2"')}}, this.closed = function () {
            return o == r
            ...
            p = r.width > 0 ? parseInt(r.width) : 450, d = r.height > 0 ? parseInt(r.height) : 300, n.one("load", function () {
                ...
                }), e.fn.resizable && i.resizable({handles: "se", minWidth: 350, minHeight: 120, resize: function () {
                    s.trigger("changesize")
                }}), t.change(function () {
                    t.opened() && (t.value ? s.trigger(e.Event("update", {file: t.value})) : i.trigger("close"))
        ...
        r.bind("update", function (s) {
            ...
            e.inArray(o.mime, n) !== -1 && (s.stopImmediatePropagation(), r.one("change", function () {
                !u.isResolved() && !u.isRejected() && u.reject()
            }), u = i.request({data: {cmd: "get", target: o.hash, current: o.phash}, preventDefault: !0}).done(function (n) {
        ...
        i.bind("update", function (s) {
            ...
            }), a = n.request({data: {cmd: "get", target: o.hash}, preventDefault: !0}).done(function (r) {
        ...
        var n = t.preview, r = !!t.options.autoplay, i = {"audio/mpeg": "mp3", "audio/mpeg3": "mp3", "audio/mp3": "mp3", "audio/x-mpeg3": "mp3", "audio/x-mp3": "mp3", "audio/x-wav": "wav", "audio/wav": "wav", "audio/x-m4a": "m4a", "audio/aac": "m4a", "audio/mp4": "m4a", "audio/x-mp4": "m4a", "audio/ogg": "ogg"}, s;
        ...
        var n = t.preview, r = !!t.options.autoplay, i = {"video/mp4": "mp4", "video/x-m4v": "mp4", "video/ogg": "ogg", "application/ogg": "ogg", "video/webm": "webm"}, s;
        n.bind("update",function (o) {
            var u = o.file, a = i[u.mime];
        ...
        this.shortcuts = [
            ...
            var t = this.fm, n = t.getUI("cwd"), r = t.selected(), i = r.length, s = t.file(r.shift()), o = ".elfinder-cwd-filename", u = e.Deferred().fail(function (e) {
                ...
                if (r.length) {
                    ...
                    r.html(t.escape(n)), t.lockfiles({files: [s.hash]}), t.request({data: {cmd: "rename", target: s.hash, name: n}, notify: {type: "rename", cnt: 1}}).fail(function (e) {
                        u.reject(), t.sync()
                    }).done(function (e) {
                        u.resolve(e)
                    }).always(function () {
            ...
            }), f = n.find("#" + s.hash).find(o).empty().append(a.val(s.name)), l =
                a.val().replace(/\.((tar\.(gz|bz|bz2|z|lzo))|cpio\.gz|ps\.gz|xcf\.(gz|bz2)|[a-z0-9]{1,4})$/ig, "");
        ...
        this.updateOnSelect = !1, this.getstate = function () {
            ...
            var n = this.fm, r = this.files(t), i = e.Deferred(), s = function (t, r) {
                var s = e('<div class="elfinder-dialog-resize"/>'), o = '<input type="text" size="5"/>', u = '<div class="elfinder-resize-row"/>', a = '<div class="elfinder-resize-label"/>', f = e('<div class="elfinder-resize-control"/>'), l = e('<div class="elfinder-resize-preview"/>'), c = e('<div class="elfinder-resize-spinner">' + n.i18n("ntfloadimg") + "</div>"), h = e('<div class="elfinder-resize-handle"/>'), p = e('<div class="elfinder-resize-handle"/>'), d = e('<div class="elfinder-resize-uiresize"/>'), v = e('<div class="elfinder-resize-uicrop"/>'), m = '<div class="ui-widget-content ui-corner-all elfinder-buttonset"/>', g = '<div class="ui-state-default elfinder-button"/>', y = '<span class="ui-widget-content elfinder-toolbar-button-separator"/>', b = e('<div class="elfinder-resize-rotate"/>'), w = e(g).attr("title", n.i18n("rotate-cw")).append(e('<span class="elfinder-button-icon elfinder-button-icon-rotate-l"/>').click(function () {
                ...
                }), A = e(o), O = e(o), M = e(o), _ = e(o), D = e('<input type="text" size="3" maxlength="3" value="0" />').change(function () {
                    et.update()
                }), P = e('<div class="elfinder-resize-rotate-slider"/>').slider({min: 0, max: 359, value: D.val(), animate: !0, change: function (e, t) {
                    t.value != P.slider("value") && et.update(t.value)
                }, slide: function (e, t) {
                    et.update(t.value, !1)
                }}), H = 1, B = 1, j = 0, F = 0, I = !0, q = 0, R = 0, U = 0, z = 0, W = 0, X = e("<img/>").load(function () {
                ...
                }}, et = {mouseStartAngle: 0, imageStartAngle: 0, imageBeingRotated: !1, update: function (t, n) {
                    typeof t == "undefined" && (W = t = parseInt(D.val())), typeof n == "undefined" && (n = !0), !n || e.browser.opera || e.browser.msie && parseInt(e.browser.version) < 9 ? Q.rotate(t) : Q.animate({rotate: t + "deg"}), t %= 360, t < 0 && (t += 360), D.val(parseInt(t)), P.slider("value", D.val())
                }, execute: function (e) {
                    if (!et.imageBeingRotated)return;
                    var t = et.getCenter(Q), n = e.pageX - t[0], r = e.pageY - t[1], i = Math.atan2(r, n), s = i - et.mouseStartAngle + et.imageStartAngle;
                    ...
                    var n = et.getCenter(Q), r = t.pageX - n[0], i = t.pageY - n[1];
                    ...
                    var t = Q.rotate();
                    Q.rotate(0);
                    var n = Q.offset(), r = n.left + Q.width() / 2, i = n.top + Q.height() / 2;
                    return Q.rotate(t), Array(r, i)
                }}, tt = function (t) {
                    e.fn.resizable && (t ? (h.resizable("destroy"), h.hide()) : (h.show(), h.resizable({alsoResize: X, aspectRatio: I, resize: Y.update, stop: Y.fixHeight})))
                }, nt = function (t) {
                    e.fn.draggable && e.fn.resizable && (t ? (p.resizable("destroy"), p.draggable("destroy"), V.hide()) : (J.width(X.width()).height(X.height()), K.width(X.width()).height(X.height()), p.width(J.width()).height(J.height()).offset(J.offset()).resizable({containment: V, resize: Z.resize_update, handles: "all"}).draggable({handle: p, containment: J, drag: Z.update}), V.show().width(X.width()).height(X.height()), Z.update()))
                }, rt = function (t) {
                    ...
                    k.add(L).change();
                    if (l == "resize")r = parseInt(k.val()) || 0, o = parseInt(L.val()) || 0; else if (l == "crop")r = parseInt(M.val()) || 0, o = parseInt(_.val()) || 0, u = parseInt(A.val()) || 0, a = parseInt(O.val()) || 0; else if (l = "rotate") {
                    ...
                    s.elfinderdialog("close"), n.request({data: {cmd: "resize", target: t.hash, width: r, height: o, x: u, y: a, degree: f, mode: l}, notify: {type: "resize", cnt: 1}}).fail(function (e) {
                        i.reject(e)
                    }).done(function () {
                        i.resolve()
                    })
                ...
                }, st[n.i18n("btnApply")] = it, n.dialog(s, {title: t.name, width: 650, resizable: !1, destroyOnClose: !0, buttons: st, open: function () {
                    l.zIndex(1 + e(this).parent().zIndex())
                }}).attr("id", r), e.browser.msie && parseInt(e.browser.version) < 9 && e(".elfinder-dialog").css("filter", ""), x.css("left", k.position().left + k.width() + 12), K.css({opacity: .2, "background-color": "#fff", position: "absolute"}), p.css("cursor", "move"), p.find(".elfinder-resize-handle-point").css({"background-color": "#fff", opacity: .5, "border-color": "#000"}), Q.css("cursor", "pointer"), T.buttonset(), q = l.width() - (h.outerWidth() - h.width()), R = l.height() - (h.outerHeight() - h.height()), X.attr("src", ft + (ft.indexOf("?") === -1 ? "?" : "&") + "_=" + Math.random()), J.attr("src", X.attr("src")), Q.attr("src", X.attr("src"))
            }, o, u;
        ...
        e.cssHooks.rotate = {get: function (t, n, r) {
            return e(t).rotate()
        }, set: function (t, n) {
            return e(t).rotate(n), n
        }}, e.cssHooks.transform = {get: function (e, n, r) {
        ...
        if (e.browser.msie && parseInt(e.browser.version) < 9) {
            var n = function (e) {
                ...
                var h = parseInt(e.style.width || e.width || 0), p = parseInt(e.style.height || e.height || 0), f = a * Math.PI / 180, d = Math.abs(Math.cos(f)), v = Math.abs(Math.sin(f)), m = (h - (h * d + p * v)) / 2, g = (p - (h * v + p * d)) / 2;
        ...
        this.shortcuts = [
            ...
            }), i.isRejected() || (s = this.hashes(t), r.confirm({title: n.title, text: "confirmRm", accept: {label: "btnRm", callback: function () {
                r.lockfiles({files: s}), r.request({data: {cmd: "rm", targets: s}, notify: {type: "rm", cnt: o}, preventFail: !0}).fail(function (e) {
                    i.reject(e)
                }).done(function (e) {
        ...
        this.title = "Find files", this.options = {ui: "searchbutton"}, this.alwaysEnabled = !0, this.updateOnSelect = !1, this.getstate = function () {
            ...
            var n = this.fm;
            return typeof t == "string" && t ? (n.trigger("searchstart", {query: t}), n.request({data: {cmd: "search", q: t}, notify: {type: "search", cnt: 1, hideCnt: !0}})) : (n.getUI("toolbar").find("." + n.res("class", "searchbtn") + " :text").focus(), e.Deferred().reject())
        }
        ...
        this.disableOnSearch = !0, this.updateOnSelect = !1, this.shortcuts = [
            ...
            return this.disabled() ? e.Deferred().reject() : n && (n.input || n.files) ? r.upload(n) : (s = e.Deferred(), u = e('<input type="file" multiple="true"/>').change(function () {
                ...
                e.stopPropagation(), e.preventDefault(), i({files: e.dataTransfer.files})
            }, !1)), r.dialog(o, {title: this.title, modal: !0, resizable: !1, destroyOnClose: !0}), s)
        }
